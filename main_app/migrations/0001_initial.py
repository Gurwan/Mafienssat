# Generated by Django 2.2.24 on 2022-03-17 14:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, unique=True)),
                ('allo_type', models.CharField(blank=True, choices=[('A', 'Bières'), ('B', 'Goûter'), ('C', "P'tit dej"), ('D', 'Ménage'), ('E', 'Car wash'), ('F', 'Le klaxeur fou'), ('G', 'Cuisine'), ('H', 'Courses'), ('I', 'Allo de la semaine'), ('J', 'Allo surprise')], help_text='Which type of allo', max_length=1)),
