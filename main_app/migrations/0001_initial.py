# Generated by Django 4.0.2 on 2022-02-25 21:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, unique=True)),
                ('allo_type', models.CharField(blank=True, choices=[('A', 'Bières'), ('B', 'Goûter'), ('C', "P'tit dej"), ('D', 'Ménage'), ('E', 'Car wash'), ('F', 'Le klaxeur fou'), ('G', 'Bricolage'), ('H', 'Cuisine'), ('I', 'Courses'), ('J', 'Taxi')], help_text='Which type of allo', max_length=1)),
