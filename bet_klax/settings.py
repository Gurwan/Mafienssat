"""
Django settings for bet_klax project.
...
WSGI_APPLICATION = 'bet_klax.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static'), BASE_DIR.joinpath('static')]
...
CRONJOBS = [
    ...
    ('0-30 * * * *', 'main_app.cron.my_cron_allos'),
    ('0-30 * * * *', 'main_app.cron.my_cron_events'),
]
